<h2><a href="https://leetcode.com/problems/minimum-number-of-string-groups-through-transformations">4000. Largest Integer With Given Digit Sum</a></h2><h3>Easy</h3><hr><p>You are given two non-negative integers <code>n</code> and <code>s</code>.</p>
