<h2><a href="https://leetcode.com/problems/number-of-elapsed-seconds-between-two-times">3987. Minimum Total Cost to Process All Elements</a></h2><h3>Medium</h3><hr><p>You are given an integer array <code>nums</code> and an integer <code>k</code>.</p>
